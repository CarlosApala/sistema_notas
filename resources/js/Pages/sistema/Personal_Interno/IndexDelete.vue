            ...
            <table class="table-auto w-full border-collapse border border-gray-300">
                <thead>
                    <tr class="bg-gray-200">
                        ...
                        <th class="border border-gray-300 px-4 py-2 text-left" style="max-width: 120px;">Carnet
                            Identidad</th>
                        <th class="border border-gray-300 px-4 py-2 text-left" style="max-width: 130px;">Fecha
                            Nacimiento</th>
                        <th class="border border-gray-300 px-4 py-2 text-left" style="max-width: 140px;">Nacionalidad
                        </th>
                        <th class="border border-gray-300 px-4 py-2 text-left" style="max-width: 140px;">Número Celular
                        </th>
