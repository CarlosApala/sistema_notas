        ...
        <div v-else>
            ...
            <form @submit.prevent="submit"
                ...
                <div>
                    ...
                    <select v-model="form.genero" id="genero" class="form-input w-full border rounded px-3 py-2">
...
const form = ref({
    ...
    direccion: props.personal.direccion || '',
    genero: props.personal.genero || '',
    lugar_nacimiento: props.personal.lugar_nacimiento || '',
