  ...
  <div class="container mx-auto p-4">
    ...
    <div class="d-flex justify-between align-items-center mb-4 flex-wrap gap-2">
      ...
      <div class="flex gap-2 flex-wrap">
        <Link href="/sistema/usuarios_lecturadores/create" class="btn btn-success">
          Nuevo Lecturador
        </Link>

        <Link :href="filters.deleted ? '/sistema/usuarios_lecturadores' : '/sistema/usuarios_lecturadores?deleted=true'"
