        ...
        <form @submit.prevent="submit"
            ...
            <div>
                ...
                <input v-model="form.zonaBarrio" id="zonaBarrio" type="text"
                    class="form-input w-full border rounded px-3 py-2 cursor-pointer" readonly @click="abrirModal"
            ...
            <p v-if="errors.PredioHabitado" class="text-red-600 text-sm mt-1 md:col-span-2">
...
import TablaModal from '@/Components/TablaModal.vue'  // <-- Importa aquí
