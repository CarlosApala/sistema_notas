...
@section('contenido')
<div class="container">
    <h1>Editar Asignación de Ruta a Lecturador</h1>
    ...
    <div class="row">
        {{-- Columna formulario --}}
        <div class="col-md-6">
            <form action="{{ route('lecturadores.update', $asignacion->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <select name="idRuta" id="idRuta" class="form-select @error('idRuta') is-invalid @enderror" required>
                        ...
                        <option value="{{ $ruta->id }}"
                            {{ (old('idRuta') ?? $asignacion->idRuta) == $ruta->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <select name="idUser" id="idUser" class="form-select @error('idUser') is-invalid @enderror" required>
                        ...
                        <option value="{{ $usuario->id }}"
                            {{ (old('idUser') ?? $asignacion->idUser) == $usuario->id ? 'selected' : '' }}>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Mostrar valores actuales al cargar la página
        if (rutaSelect.value) {
